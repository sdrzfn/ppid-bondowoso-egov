            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div><span class="text-slate-500">Nama:</span>
                            <p class="font-medium"><?= htmlspecialchars($ticket['nama_lengkap']) ?></p>
                        </div>
                        <div><span class="text-slate-500">NIK:</span>
                            <p class="font-medium font-mono"><?= htmlspecialchars($ticket['nik']) ?></p>
                        </div>
                        <div><span class="text-slate-500">Email:</span>
                            <p class="font-medium"><?= htmlspecialchars($ticket['email']) ?></p>
                        </div>
                        <div><span class="text-slate-500">WhatsApp:</span>
                            <p class="font-medium"><?= htmlspecialchars($ticket['no_whatsapp']) ?></p>
                        </div>
                        <div class="col-span-2"><span class="text-slate-500">Alamat:</span>
                            <p class="font-medium"><?= nl2br(htmlspecialchars($ticket['alamat'])) ?></p>
                        </div>
                    </div>
                    <?php if ($ticket['lampiran_ktp']): ?>
                        <div class="mt-4">
                            <span class="text-slate-500 text-sm">Lampiran KTP:</span>
                            <a href="<?= htmlspecialchars($ticket['lampiran_ktp']) ?>" target="_blank"
                                class="text-sky-600 hover:underline text-sm ml-2">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="space-y-4 text-sm">
                        <div>
                            ...
                            <p class="font-medium mt-1 bg-slate-50 p-3 rounded-lg">
                                <?= nl2br(htmlspecialchars($ticket['rincian_informasi'])) ?></p>
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div><span class="text-slate-500">Format:</span>
                                <p class="font-medium capitalize"><?= $ticket['format_salinan'] ?></p>
                            </div>
                            <div><span class="text-slate-500">Cara Penyampaian:</span>
                                <p class="font-medium capitalize">
                                    <?= str_replace('_', ' ', $ticket['cara_penyampaian']) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        if ($history && $history->num_rows > 0):
                            while ($h = $history->fetch_assoc()):
                                ...
                                <div class="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
                                    <div
                                        class="w-8 h-8 bg-sky-100 text-sky-700 rounded-full flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="text-sm">
                                        ...
                                        <p class="text-xs text-slate-400 mt-1">
                                            ...
                                            <?= htmlspecialchars($h['updated_by']) ?></p>
                                    </div>
                                </div>
                            <?php endwhile; endif; ?>
                    </div>
                ...
                <div class="bg-white shadow rounded-lg p-6 sticky top-24">
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-200">
                        ...
                        <div class="text-xs text-slate-500 space-y-1">
                            ...
                            <p>Diperbarui: <?= date('d/m/Y H:i', strtotime($ticket['updated_at'])) ?></p>
