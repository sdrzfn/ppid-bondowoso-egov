                    ...
                    <?php if ($tickets && $tickets->num_rows > 0): ?>
                        <?php while ($t = $tickets->fetch_assoc()): ?>
                            <tr class="border-t border-slate-200 hover:bg-slate-50">
                                <td class="px-4 py-3 font-mono font-medium text-sky-700"><?= htmlspecialchars($t['ticket_number']) ?></td>
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    ?>
                                    <span class="inline-block px-2 py-1 rounded-full text-xs font-medium <?= $statusColors[$t['status']] ?>">
                                        <?= $statusLabels[$t['status']] ?>
                                    </span>
                                </td>
                                <td class="px-4 py-3 text-slate-500"><?= date('d/m/Y H:i', strtotime($t['created_at'])) ?></td>
                                <td class="px-4 py-3 text-center">
                                    <a href="ticket-detail.php?id=<?= $t['id'] ?>" class="text-sky-600 hover:text-sky-800 mr-2">
